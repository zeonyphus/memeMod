package xen.modone.blocks.tileentity;
...
import xen.modone.blocks.machines.MemeProcessorRecipes;
import xen.modone.init.ModBlocks;

import javax.annotation.Nullable;

public class TileEntityMemeProcessor extends TileEntity implements IInventory, ITickable {
    ...
    public String getName() {
        return this.hasCustomName() ? this.customName : "container.meme_processor";
    }
    ...
    public void update(){
        ...
        if(!this.world.isRemote){
            ...
            if(flag != this.isBurning()){
                flag1 = true;
                BlockMemeProcessor.setState(this.isBurning(), this.world, this.pos);
            }
    ...
    private boolean canSmelt(){
        if(((ItemStack)this.inventory.get(0)).isEmpty() || ((ItemStack)this.inventory.get(1)).isEmpty()) return false;
            ...
            ItemStack result = MemeProcessorRecipes.getInstance().getProcessingResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
    ...
    public void smeltItem(){
         if(this.canSmelt()){
             ...
             ItemStack result = MemeProcessorRecipes.getInstance().getProcessingResult(input1, input2);
             ItemStack output = (ItemStack)this.inventory.get(3);
    ...
    public static int getItemBurnTime(ItemStack fuel){
        if(fuel.isEmpty()) return 0;
            ...
            if(item instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.AIR){
                ...
                if (block == ModBlocks.memeLog) return 3200;
                else return 0;
            }else{
                return 0;
            }
